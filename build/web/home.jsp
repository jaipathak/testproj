    ...
    <body>
            ...
            <div id="slider">
                <div class="flexslider">
                  <ul class="slides">
                    <li>
                        <img src="images/ban1.jpg" alt="ban1" />
                    </li>
                    <li>

                      <img src="images/ban5.jpg" alt="ban5" />
                    </li>
                      <li>

                      <img src="images/ban6.jpg" alt="ban6" />
                    </li>
                      
                    <li>
                        <div class="slider-caption">
                            <h1>Enjoy your Journy</h1>
                            <br><br>
                            <a href="booking.jsp">Get Ready</a>
                        </div>
                      <img src="images/ban2.jpg" alt="ban2" />
                    </li>
                  </ul>
                </div>
            </div>
