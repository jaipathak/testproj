    ...
    <body>
            ...
            <div id="slider">
                <div class="flexslider">
                    <div id="flexi">
                     <h1 style="margin-left: 420px;color: #f78e21;margin-top: 20px"> Charges Per Kilometer</h1>
                     <table id="tb" border="1 solid">
                         <tr>  <th>Cab-Type</th> <th>Rs/first 3km</th><th>Rs/after 3km</th> </tr>
                         <tr><td>Mini-Taxi </td><td>40Rs</td><td>5Rs</td></tr>
                         <tr><td>Sedan </td><td>60Rs</td><td>7Rs</td></tr>
                         <tr><td>SUV </td><td>80Rs</td><td>9Rs</td></tr>
                           
                     </table>
                            <div class="send">
                                <a style="margin-left: 510px;font-size: 22px" href="booking.jsp">Let's Start ride</a>
                               </div>
